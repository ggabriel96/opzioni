...
auto limit_within(std::string const &text, std::size_t const max_width, std::size_t const margin_left) noexcept
...
auto limit_within(std::string const &text, std::size_t const max_width) noexcept
    -> std::vector<std::vector<std::string_view>> {
